...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1495226742124843048  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1496672086247342261
MATCH_TIMES_CHANNEL_ID = 1501778373507153940
ASSIGNMENTS_CHANNEL_ID = 1501778439923830815
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1496672164626174062  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1496996527166459994
CO_CAPTAIN_ROLE_ID = 1501779136568496282
EXECUTIVE_ROLE_ID = 1504981030338039938
TEAM_PLAYER_ROLE_ID = 1501779103525900459
...
FAQ_CHANNEL_ID = 1495232879867985941  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1503051718747885610  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1504981602466533417  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1504981634594640082     # 🎉 Event Ping
...
class FAQRoleView(discord.ui.View):
    ...
    @discord.ui.button(label="🎥 Match stream ping", style=discord.ButtonStyle.blurple)
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the MMM FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "#  Ascending Gorilla Tag Frequently Asked Questions\n\n"
        "## If this doesn’t answer your questions head to #agt-questions and ask your question \n\n"
        " :grey_question: **how do I make a team**\n"
        ">   making a team is way easier than you think.\n"
        "> make a discord server like the ones in <#1496672350190567595> \n"
        " :grey_question: **how do I join a team**\n"
        "> > to join a team go in <#1496672350190567595> wait for tryouts and wait for the owner to tell you if you’re in the clan.\n"
        "> to join a clan in this league you have the captain do /invite then wait\n"
        " :grey_question: **How do I open a ticket**\n\n"
        ">  To open a ticket make sure you are reporting someone, questions go in \n\n"
        "> to report someone go in\n"
        " :grey_question: **How does my team become official**\n\n"
        "> > When we look for official teams we are looking for two things:\n\n"
        "> - Team Activity\n"
        "> - Team Size\n"
        "> - The best way to become official is to get 10 players on your team, and be active.\n\n"
        "# ー Role Assign\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"MMM{random.randint(1000, 9999)}"
